  ...
  module V1
    module Products
      module IosysCrawlSettings
        class IosysCrawlSettingExcludeProductsController < Api::ApplicationController
          def index
            render json: {
              iosys_crawl_setting_exclude_products: exclude_products
            }, status: :ok
          end
          ...
          def exclude_products
            @exclude_products ||= product.iosys_crawl_setting
